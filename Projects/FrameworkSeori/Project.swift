...
let project = Project(name: "FrameworkSeori", organizationName: "seoyoung", options: .options(), packages: [], settings: nil, targets: [
    Target(name: "FrameworkSeori", platform: .iOS, product: .app, productName: "FrameworkSeori", bundleId: "seoyoung", deploymentTarget: nil, infoPlist: nil, sources: "Sources/**", resources: nil, copyFiles: nil, headers: nil, entitlements: nil, scripts: [], dependencies: [
        
    ], settings: nil, coreDataModels: [], environment: [:], launchArguments: [], additionalFiles: []),
    Target(name: "FrameworkSeoriTests", platform: .iOS, product: .unitTests, productName: "FrameworkSeoriTests", bundleId: "seoyoung", deploymentTarget: nil, infoPlist: nil, sources: "Tests/**", resources: nil, copyFiles: nil, headers: nil, entitlements: nil, scripts: [], dependencies: [], settings: nil, coreDataModels: [], environment: [:], launchArguments: [], additionalFiles: [])
